...
```{r}
fotr <- read.csv('1808The_Fellowship_Of_The_Ring.csv')
rotk <- read.csv('1808The_Return_Of_The_King.csv')
tt <- read.csv('1808The_Two_Towers.csv')
...
```{r}
lotr <- read.csv('1808lotr-tidy.csv')
View(lotr)
```
