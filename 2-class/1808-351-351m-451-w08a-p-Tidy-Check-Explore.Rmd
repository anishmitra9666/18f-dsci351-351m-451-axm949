...
##### Answering the question
  ...
  1. Did you specify the type of data analytic question 
    ...
    - (e.g. exploration, assocation causality) 
...
##### Raw data: It is critical that you include the rawest form of the data that you have access to. 
...
Ensure that data that should be identical across iles is identical
