# Script Name: 2016 SDLE Tea_Time_Class_1.R
# Purpose: Learning R 
# Authors: Ethan Pickering 
# License: Creative Commons Attribution-NonCommercial-ShareAlike- 4.0 International License.  
# Latest Changelog Entires: v0.00.01 - tea_time_class1.R - Ethan Started it

# This is in the 2017 SDLE Tea-time Learning Repo
# https://bitbucket.org/cwrudsci/17-sdle-teatime/overview 
...
# But Google Style Guide says DON'T
# <- Assignment operator is clearer
...
# Other useful functions to mention, which(), mean(), sd(), min(), max()
  ...
  row = which(d[,1] == 2) 
  print(row)
# Note above  the two equal signs that are necessary to check for equivalence
...
# BUT only do this once in a script
# Or use a project to set the base directory path
# And you USE RELATIVE PATHS from then on.
